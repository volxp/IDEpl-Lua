...
const TextEditor::Palette& TextEditor::GetTokyoNightPalette()
{
	const static Palette p = { {
		0xff997c78,     // None
		0xfff79abb,      // Keyword    
		0xff649eff,      // Number
		0xff6ace9e,      // String
		0xff6ace9e,      // Char literal
		0xffffdd89,      // Punctuation
		0xffacdc73,      // Preprocessor
		0xfff5cac0,      // Identifier
		0xfff7a27a,      // Known identifier
		0xffd7b90d,      // Preproc identifier
		0xff7d5951,      // Comment (single line)
		0xff5d4642,      // Comment (multi line)
		0xff261b1a,      // Background
		0xfff5cac0,      // Cursor
		0x407e5c51,      // Selection
		0xa04b4bdb,      // ErrorMarker
		0x804b4bdb,      // Breakpoint
		0xff543b36,      // Line number
		0x402e201e,      // Current line fill
		0x401e1616,      // Current line fill (inactive)
		0x402e201e,      // Current line edge
		} };
	return p;
}
